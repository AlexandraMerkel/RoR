...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { cinema_timetable_id: @price.cinema_timetable_id, cost: @price.cost, zone_id: @price.zone_id }
    end
  ...
  test "should update price" do
    patch :update, id: @price, price: { cinema_timetable_id: @price.cinema_timetable_id, cost: @price.cost, zone_id: @price.zone_id }
    assert_redirected_to price_path(assigns(:price))
  end
